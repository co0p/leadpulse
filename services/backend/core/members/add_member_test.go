...
func (m *mockMemberRepository) FindInactive() ([]*TeamMember, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
	var inactive []*TeamMember
	for _, member := range m.members {
		if !member.IsActive() {
...
func (m *mockMemberRepository) FindAll() ([]*TeamMember, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
	var all []*TeamMember
	for _, member := range m.members {
...
func (m *mockMemberRepository) Update(member *TeamMember) error {
	return m.Save(member)
}
...
func (e *errorMockMemberRepository) FindInactive() ([]*TeamMember, error) {
	return []*TeamMember{}, nil
}

func (e *errorMockMemberRepository) FindAll() ([]*TeamMember, error) {
	return []*TeamMember{}, nil
}

func (e *errorMockMemberRepository) Update(member *TeamMember) error {
	return fmt.Errorf("repository error")
}
